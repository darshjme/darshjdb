...
async fn cmd_pull(cfg: &config::Config, output: &str) -> Result<()> {
    ...
    let mut ts_output = String::from("// Auto-generated by `darshan pull` — do not edit.\n\n");
...
"#;
    ...
    tokio::fs::write(project_dir.join("darshan.toml"), config_content).await?;
