# DarshanDB vs. the BaaS Market: Feature Comparison Matrix

> Last updated: 2026-04-05 | Based on DarshanDB v0.1.0 (alpha) and publicly available documentation for each platform.

This document is a factual, feature-by-feature comparison of DarshanDB against every major Backend-as-a-Service platform. Checkmarks, crosses, and "partial" labels are applied honestly -- DarshanDB is alpha software and this table reflects that.
...
|---|----------|---------------|-----------------|---------------|
| 1 | **DarshanDB** | 0.1.0-alpha | Rust | 2026 |
...
| Feature | DarshanDB | Supabase | Firebase | Convex | Neon | PocketBase | Appwrite | InstantDB | Hasura | Directus |
|---------|-----------|----------|----------|--------|------|------------|----------|-----------|--------|----------|
...
| SDK | DarshanDB | Supabase | Firebase | Convex | Neon | PocketBase | Appwrite | InstantDB | Hasura | Directus |
|-----|-----------|----------|----------|--------|------|------------|----------|-----------|--------|----------|
...
| Factor | DarshanDB | Supabase | Firebase | Convex | Neon | PocketBase | Appwrite | InstantDB | Hasura | Directus |
|--------|-----------|----------|----------|--------|------|------------|----------|-----------|--------|----------|
...
| **Auto-embedding pipeline** | Configure `DARSHAN_AUTO_EMBED_ATTRIBUTES` and every matching text write generates a vector embedding via OpenAI or Ollama, stored in pgvector automatically. No application code needed. | Working |
...
## Where DarshanDB is Behind

Honest assessment of gaps relative to established platforms:

| Gap | Who does it better | DarshanDB status |
|-----|--------------------|------------------|
...
Every DarshanDB feature claim in this document was verified by reading the source code at `packages/server/src/`, `packages/*/`, and `sdks/*/`. Specifically:
